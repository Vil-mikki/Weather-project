  ...
  return (
    <div className="weather-card">
      <div className="weather-card__header">
        <h2 className="weather-card__header-cityName">{weather.name}</h2>
        <p className="weather-card__header-description">{weather.description}</p>
      </div>
      <div className="weather-card__temperature">
        <h1 className="weather-card__temperature-temp">{weather.temperature}°C</h1>
      </div>
      <div className="weather-card__details">
        <h3 className="weather-card__details-title">Details</h3>
